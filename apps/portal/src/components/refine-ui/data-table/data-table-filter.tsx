...
function parseFilterSingleDate(value: string | undefined): Date | undefined {
...
export function DataTableFilterDropdownDateSinglePicker<TData>({
    ...
    const [filterValue, setFilterValue] = useState<Date | undefined>(() =>
        parseFilterSingleDate(columnFilterValue)
    )
    ...
    useEffect(() => {
        setFilterValue(parseFilterSingleDate(columnFilterValue))
    }, [columnFilterValue])
